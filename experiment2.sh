...
python main_last.py --cuda --plot --epochs 800 --lr 5 --lamb 0 --model LSTM --batch_size 100
echo "--epochs 800 --lr 5 --lamb 1 --model LSTM --batch_size 100"
python main_last.py --cuda --plot --epochs 800 --lr 5 --lamb 1 --model LSTM --batch_size 100
echo "--epochs 800 --lr 20 --lamb 0.5 --model LSTM --batch_size 20"
python main_last.py --cuda --plot --epochs 800 --lr 20 --lamb 0.5 --model LSTM --batch_size 20